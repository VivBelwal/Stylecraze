...
let check=localStorage.getItem("check")||false;
let signedupArr=JSON.parse(localStorage.getItem("signupDetails"))||[];
    ...
    function signupPage(){
       ...
       function loginfunc(event){
          ...
          if(loginObj.email==""||loginObj.password==""){
            ...
            signedupArr.forEach(function(ele){
              if((loginObj.email==ele.email)&&(loginObj.password==ele.password)){
                 check=true;
                 localStorage.setItem("check",check);
                 localStorage.setItem("signin",JSON.stringify(ele));
                 alert("Login Successful. Please Continue with your readings ");
                 window.location.href="index.html";
